                                            ...
                                            <div class="p-5">
                                                ...
                                                <form action="login.php" class="form-floating" method="post">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="username" placeholder="ผู้ใช้" oninvalid="setCustomValidity('กรุณาป้อนผู้ใช้')"
                                                        maxlength="10" oninput="setCustomValidity('')" required >

                                                    </div>
                                                    <div class="form-group">
                                                        <input type="password" class="form-control" name="password" placeholder="รหัสผ่าน" oninvalid="setCustomValidity('กรุณาป้อนรหัสผ่าน')"
                                                        maxlength="4" oninput="setCustomValidity('')" required id="id_password">
