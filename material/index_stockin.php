...
<div class="sidebar close">
    ...
    <div class="profile-details">
      ...
      <a href="index_stockin.php?logout='1'"> <i class='bx bx-log-out'  id="logout" ></i> </a>
    </div>
  </li>
</ul>
  </div>
  <section class="home-section">
    ...
    <div class="container">
        ...
        <div class=" h4 text-center alert alert-info mb-4 mt-4" role="alert">รับวัตถุดิบเข้าคลัง</div>
        <hr>
